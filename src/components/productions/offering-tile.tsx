 ...
 * be clickable. When I hover over them, I want the tiles to change colors,
 ...
 * portal uses for "this is the live one" rather than a new color invented
 * here.
 *
...
export function OfferingTile({
  ...
  return (
    ...
    >
      ...
      {/* Moves on hover as well as changing color, so the affordance survives
